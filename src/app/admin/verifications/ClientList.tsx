          ...
          >
            <div className="h-48 w-full bg-gray-100 relative overflow-hidden flex items-center justify-center">
              ...
              <img
                src={
                  item.imageUrl ||
                  "https://placehold.co/400x300/eee/999?text=Image+Missing"
                }
                alt="ITS Card"
                onError={(e) => {
                  e.currentTarget.src =
            ...
            <div className="p-4">
              ...
              <p className="text-gray-500 text-sm mb-2">
                {item.city || "No city provided"}
              </p>
              <p className="font-mono text-sm font-semibold text-gray-700 bg-gray-100 rounded px-2 py-1 inline-block mb-2">
                ITS: {item.itsNumber || "Not recorded"}
              </p>
            ...
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
              <div>
                <h2 className="text-xl font-bold text-gray-800">
                  Review: {selectedItem.alias}
                </h2>
                <p className="text-sm text-gray-500">{selectedItem.city}</p>
                <p className="mt-1.5 font-mono text-sm font-bold text-gray-800 bg-yellow-100 border border-yellow-300 rounded px-2.5 py-1 inline-block">
                  ITS No: {selectedItem.itsNumber || "Not recorded"}
                </p>
              </div>
              <button
            ...
            <div className="flex-1 overflow-auto bg-gray-900 flex items-center justify-center p-4">
              ...
              <img
                src={
                  ...
                  "https://placehold.co/600x400/eee/999?text=Image+Missing"
                }
                alt="Full ITS Card"
                onError={(e) => {
                  e.currentTarget.src =
